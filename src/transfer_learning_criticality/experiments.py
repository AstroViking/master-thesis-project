...
layer_variance_figure(weight_variances, bias_variances).write_image(plot_path / "variance.png")

# Test correlation across layers
with torch.no_grad():
    ...
    average_correlation_figure(correlations).write_image((plot_path / "correlation.png"))